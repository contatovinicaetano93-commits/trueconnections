  ...
  return (
    <div>
      ...
      {eventos.items.length === 0 ? (
        <div className="rounded-2xl border border-[hsl(32_14%_78%/0.3)] bg-[hsl(38_28%_96%/0.15)] px-5 py-12 text-center">
          <Calendar
            className="mx-auto mb-4 h-10 w-10 text-[hsl(24_8%_34%)]/25"
            strokeWidth={1.4}
          />
          <p className="font-[family-name:var(--font-body)] text-sm text-[hsl(24_8%_34%)]">
            {eventos.empty}
